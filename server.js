...
// Retrieve the id of the item to be deleted from the request params, and then call ShoppingList.delete() with that value.  Send back a blank response with a 204 statis cpde/
